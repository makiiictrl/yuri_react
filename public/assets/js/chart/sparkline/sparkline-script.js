(function ($) {
  ...
  setTimeout(function () {
    $("#line-chart-sparkline").sparkline(
      [5, 10, 20, 14, 17, 21, 20, 10, 4, 13, 0, 10, 30, 40, 10, 15, 20],
      {
        ...
        lineColor: yuriAdminConfig.primary,
        fillColor: "rgba(0 , 157, 181, 0.40)",
        highlightLineColor: yuriAdminConfig.primary,
        highlightSpotColor: yuriAdminConfig.primary,
        targetColor: yuriAdminConfig.primary,
        performanceColor: yuriAdminConfig.primary,
        boxFillColor: yuriAdminConfig.primary,
        medianColor: yuriAdminConfig.primary,
        minSpotColor: yuriAdminConfig.primary,
      }
    );
  });
  ...
  $("#custom-line-chart").sparkline([5, 30, 27, 35, 30, 50, 70], {
    ...
    tooltipClassname: "chart-sparkline",
    chartRangeMax: "50",
    lineColor: yuriAdminConfig.secondary,
    fillColor: "rgba(249 , 76, 142, 0.30)",
    highlightLineColor: "rgba(249 , 76, 142, 0.30)",
  ...
  $("#custom-line-chart").sparkline([0, 5, 10, 7, 25, 20, 30], {
    ...
    lineColor: yuriAdminConfig.primary,
    fillColor: "rgba(0 , 157, 181, 0.40)",
    highlightLineColor: "rgba(0 , 157, 181, 0.40)",
    ...
    init: function () {
      setTimeout(function () {
        ...
        $("#bar-chart-sparkline").sparkline([5, 2, 2, 4, 9, 5, 7, 5, 2, 2, 6], {
          ...
          height: "100%",
          tooltipClassname: "chart-sparkline",
          barColor: yuriAdminConfig.primary,
        }),
