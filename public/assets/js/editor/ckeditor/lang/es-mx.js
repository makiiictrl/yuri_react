...
CKEDITOR.lang["es-mx"] = {
  ...
  common: {
    ...
    invalidCssLength:
      'El valor especificado para el campo "% 1" debe ser un número posiyuri con o sin una unidad de medida CSS válida (px, %, in, cm, mm, em, ex, pt, or pc).',
    invalidHtmlLength:
      'El valor especificado para el campo "% 1" debe ser un número posiyuri con o sin una unidad de medición HTML válida (px or %).',
    invalidInlineStyle:
  ...
  link: {
    ...
    advanced: "Avanzada",
    advisoryContentType: "Tipo de contenido consulyuri",
  ...
  table: {
    ...
    invalidCellPadding: "El relleno de la celda debe ser un número posiyuri.",
    invalidCellSpacing: "El espacio de la celda debe ser un número posiyuri.",
