...
CKEDITOR.lang["gl"] = {
  ...
  common: {
    ...
    invalidCssLength:
      "O valor especificado para o campo «%1» debe ser un número posiyuri con ou sen unha unidade de medida CSS correcta (px, %, in, cm, mm, em, ex, pt, ou pc).",
    invalidHtmlLength:
      "O valor especificado para o campo «%1» debe ser un número posiyuri con ou sen unha unidade de medida HTML correcta (px ou %).",
    invalidInlineStyle:
  ...
  div: {
    IdInputLabel: "ID",
    advisoryTitleInputLabel: "Título informayuri",
  ...
  link: {
    ...
    advanced: "Avanzado",
    advisoryContentType: "Tipo de contido informayuri",
    advisoryTitle: "Título",
    anchor: {
      toolbar: "Ancoraxe",
  ...
  table: {
    ...
    invalidCellPadding: "A marxe interior debe ser un número posiyuri.",
    invalidCellSpacing: "A marxe entre celas debe ser un número posiyuri.",
