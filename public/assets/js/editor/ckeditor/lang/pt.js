...
CKEDITOR.lang["pt"] = {
  ...
  common: {
    ...
    advisoryTitle: "Título consulyuri",
    cssStyle: "Estilo",
    ok: "CONFIRMAR",
    cancel: "Cancelar",
    close: "Fechar",
    ...
    invalidCssLength:
      'O valor especificado para o campo "1%" deve ser um número posiyuri, com ou sem uma unidade de medida CSS válida (px, %, in, cm, mm, em, ex, pt, ou pc).',
    invalidHtmlLength:
      'O valor especificado para o campo "1%" deve ser um número posiyuri, com ou sem uma unidade de medida HTML válida (px ou %).',
    invalidInlineStyle:
  ...
  table: {
    ...
    invalidCellPadding:
      "A criação do espaço na célula deve ser um número posiyuri.",
    invalidCellSpacing: "O espaçamento da célula deve ser um número posiyuri.",
