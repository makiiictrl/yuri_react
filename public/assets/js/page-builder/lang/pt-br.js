...
CKEDITOR.lang["pt-br"] = {
  ...
  common: {
    ...
    invalidCssLength:
      'O valor do campo "%1" deve ser um número posiyuri opcionalmente seguido por uma válida unidade de medida de CSS (px, %, in, cm, mm, em, ex, pt ou pc).',
    invalidHtmlLength:
      'O valor do campo "%1" deve ser um número posiyuri opcionalmente seguido por uma válida unidade de medida de HTML (px ou %).',
    invalidInlineStyle:
