...
CKEDITOR.lang["es"] = {
  ...
  common: {
    ...
    invalidCssLength:
      'El valor especificado para el campo "%1" debe ser un número posiyuri, incluyendo optionalmente una unidad de medida CSS válida (px, %, in, cm, mm, em, ex, pt, o pc).',
    invalidHtmlLength:
      'El valor especificado para el campo "%1" debe ser un número posiyuri, incluyendo optionalmente una unidad de medida HTML válida (px o %).',
    invalidInlineStyle:
