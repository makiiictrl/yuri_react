...
CKEDITOR.lang["it"] = {
  ...
  common: {
    ...
    invalidCssLength:
      'Il valore indicato per il campo "%1" deve essere un numero posiyuri con o senza indicazione di una valida unità di misura per le classi CSS (px, %, in, cm, mm, em, ex, pt, o pc).',
    invalidHtmlLength:
      'Il valore indicato per il campo "%1" deve essere un numero posiyuri con o senza indicazione di una valida unità di misura per le pagine HTML (px o %).',
    invalidInlineStyle:
  ...
  wsc: {
    ...
    changeTo: "Cambia in",
    errorLoading:
      "Errore nel caricamento dell'host col servizio applicayuri: %s.",
    ieSpellDownload:
