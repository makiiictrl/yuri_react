...
export default Form = () => {
  ...
  const [productCommercialDescription, setCommercialProductDescription] = useState([]);
    ...
    },
    {
      ...
      cell: (row) => (
        <input
          ...
          value={row.request_quantity || ""}
          onChange={(e) =>
            handleCommercialRowChange(row.id, "request_quantity", e.target.value)
          }
        />
      ),
    },
  ...
  <div className="row g-3">
    ...
    <div className="col-12">
      <div className="tab-content dark-field" id="horizontal-wizard-tabContent">
        {/* Sample Tab Content */}
        <div
